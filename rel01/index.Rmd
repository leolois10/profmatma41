...
Apresentamos neste relatório, duas ferramentas poderosissímas, para edição de textos. Que comportam imagens, links, figuras, tabelas, fórmulas matemáticas, ... Que acreditamos ser essenciais para serem utilizadas no seu texto científico. Mais informações, consulte as fontes indicadas no texto.
